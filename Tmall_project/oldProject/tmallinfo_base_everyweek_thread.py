        ...
        for one_shop in page_all_shop:
            ...
            if name == shop_name:
                ...
                if one_shop.find_element_by_css_selector('div.shop-avg li:nth-child(2) span').get_attribute(
                        'class') == 'lessthan':
                    dsr_desc_avg = '-' + one_shop.find_element_by_css_selector(
                        'div.shop-avg li:nth-child(2) span').text[2:]
                else:
                ...
                if one_shop.find_element_by_css_selector('div.shop-avg li:nth-child(3) span').get_attribute(
                        'class') == 'lessthan':
                    dsr_service_avg = '-' + one_shop.find_element_by_css_selector(
                        'div.shop-avg li:nth-child(3) span').text[2:]
                else:
                ...
                if one_shop.find_element_by_css_selector('div.shop-avg li:nth-child(4) span').get_attribute(
                        'class') == 'lessthan':
                    dsr_sending_avg = '-' + one_shop.find_element_by_css_selector(
                        'div.shop-avg li:nth-child(4) span').text[2:]
                else:
                ...
                shop_data_temp = [name, href, judgePage_href, seller, addr, brand, monthsale,
                                  ...
                                  product_link_1, price_1, product_link_2, price_2, product_link_3, price_3,
                                  product_link_4, price_4, week, spider_time]
                break
